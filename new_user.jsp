...
<table>
	...
	<tr><td>생년월일</td><td><input type="year" name="year" size="10"></td></tr>
	<tr><td>비밀번호</td><td><input type="password" name="passwd" size="10" required> <input class="jitol" type="submit" value="회원등록"></td></tr>
</table> 
</form>
</body>
</html> 